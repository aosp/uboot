...
/* GPIO */
#define OMAP44XX_GPIO1_BASE	(OMAP44XX_L4_WKUP_BASE+ 0x10000 + 0x0000)
#define OMAP44XX_GPIO2_BASE	(OMAP44XX_L4_PER_BASE + 0x50000 + 0x5000)
#define OMAP44XX_GPIO3_BASE	(OMAP44XX_L4_PER_BASE + 0x50000 + 0x7000)
#define OMAP44XX_GPIO4_BASE	(OMAP44XX_L4_PER_BASE + 0x50000 + 0x9000)
#define OMAP44XX_GPIO5_BASE	(OMAP44XX_L4_PER_BASE + 0x50000 + 0xb000)
#define OMAP44XX_GPIO6_BASE	(OMAP44XX_L4_PER_BASE + 0x50000 + 0xd000)
